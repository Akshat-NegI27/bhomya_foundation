    ...
    <Curve backgroundColor="#000">
      <div className="aboutpg">
        ...
        <section className="intro">
          <h2>About Us</h2>
          <p>
            Bhomya Foundation is a Dehradun-based environmental NGO working
            since June 2022, officially registered on 7th February 2024 under
            the Society Act (Reg. No. UK0600822024012700).
          </p>
          <p>
        ...
        <section className="mission">
          ...
          <p>
            ...
            nature — restoring ecosystems, protecting biodiversity, and
